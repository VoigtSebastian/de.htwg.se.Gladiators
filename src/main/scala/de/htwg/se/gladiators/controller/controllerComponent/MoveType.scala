...
object MoveType extends Enumeration {
    type MoveType = Value
    val LEGAL_MOVE, ILLEGAL_MOVE, ATTACK, BLOCKED, MOVE_TO_PALM, UNIT_NOT_OWNED_BY_PLAYER, INSUFFICIENT_MOVEMENT_POINTS, UNIT_NOT_EXISTING, GOLD, BASE_ATTACK, ALREADY_MOVED, MOVE_OUT_OF_BOUNDS, OWN_BASE = Value
