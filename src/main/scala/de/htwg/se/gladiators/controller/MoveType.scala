...
object MoveType extends Enumeration {
    type MoveType = Value
    val LEGAL_MOVE, ILLEGAL_MOVE, ATTACK, BLOCKED, MOVE_TO_PALM, UNIT_NOT_OWNED_BY_PLAYER, INSUFFICIENT_MOVEMENT_POINTS, UNIT_NOT_EXISTING, GOLD, MOVE_TO_BASE = Value
    ...
    val map = Map[MoveType, String](
        ...
        GOLD -> "Mining Gold",
        MOVE_TO_BASE -> "You can not move to a base cell"
    )
