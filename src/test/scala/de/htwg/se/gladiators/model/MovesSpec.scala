    ...
    "A Move" when {
        "categorizing moving units" should {
            ...
            "categorize legal moves" in {
                val currentPlayer = Player("", 0, 0, Vector(createGladiator(position = Some(Coordinate(0, 0)), movementPoints = Some(4), moved = Some(false))))
            ...
            "categorize illegal moves" in {
                val currentPlayer = Player("", 0, 0, Vector(createGladiator(position = Some(Coordinate(0, 0)), movementPoints = Some(0), moved = Some(false))))
            ...
            "categorize a tile as blocked" in {
                val currentPlayer = Player("", 0, 0, Vector(createGladiator(position = Some(Coordinate(0, 0)), movementPoints = Some(1), moved = Some(false)), createGladiator(position = Some(Coordinate(0, 1)))))
